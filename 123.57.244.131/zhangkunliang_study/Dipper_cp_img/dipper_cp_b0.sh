...
sourcedir="/home/zhang/ithing-dipper8/out/target/product/dipper8b0"


function cleanfile
{
	echo "clear file is start dipper8b0"
	...
	echo "clear file is end dipper8b0"
}
...
function cpfile
{
	...
	echo "copy file is start dipper8b0"
	...
	echo "copy file is end dipper8b0"
