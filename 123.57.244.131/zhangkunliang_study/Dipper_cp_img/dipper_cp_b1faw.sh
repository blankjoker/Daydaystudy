...
sourcedir="/home/zhang/ithing-dipper8/out/target/product/dipper8b1faw"


function cleanfile
{

	echo "clear file is start dipper8b1faw"
	...
	echo "clear file is end dipper8b1faw"
}
...
function cpfile
{
	...
	echo "copy file is start dipper8b1faw"
	...
	echo "copy file is end dipper8b1faw"
